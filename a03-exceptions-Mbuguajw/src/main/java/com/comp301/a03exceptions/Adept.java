...
public class Adept {
  ...
  public static BufferedReader section5(String urlText) throws IOException {
    ...
    InputStreamReader reading = new InputStreamReader(url.openStream());
    BufferedReader readURL = new BufferedReader(reading);
    return readURL;
  }
  ...
  public static String section6(String urlText) throws IOException {
    // TODO
    BufferedReader obtained = null;
    try {
      obtained = section5(urlText);
      String dataText = "";
      String sentence = obtained.readLine();
      while(sentence != null) {
        dataText = dataText + sentence;
        sentence = obtained.readLine();
      }
      return dataText;
    }
    catch (IOException e) {
